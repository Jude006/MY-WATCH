  ...
  return (
    <div className='mt-10 font-mont'>
      ...
      <div className='md:px-10 lg:px-24 px-4 gap-10 grid grid-cols-12 py-10'>
        <div className='md:col-span-4 col-span-12 p-4 flex flex-col gap-6 '>
            <div className='py-6 px-4 shadow relative'>
                ...
                <img src="/images/icon1.png" alt=""  className='h-14 w-14 object-cover absolute top-6 -right-8'/>
            </div>
            <div className='py-6 px-4 shadow relative'>
                ...
                <img src="/images/icon2.png" alt=""  className='h-14 w-14 object-cover absolute top-6 -right-8'/>
            </div>
            <div className='py-6 px-4 shadow relative'>
        ...
        <div className='md:col-span-4 col-span-12 p-4 flex justify-center items-center object-cover'>
        ...
        <div className='py-6 px-4 shadow relative'>
                ...
                <img src="/images/icon4.png" alt=""  className='h-14 w-14 object-cover absolute top-6 -right-8'/>
            </div>
            <div className='py-6 px-4 shadow relative'>
                <p className='font-semibold'>After-Sales Support</p>
                <p className='mt-2 '>We value your watch as much as you do.</p>
                <img src="/images/icon5.png" alt=""  className='h-14 w-14 object-cover absolute top-6 -right-8'/>
            </div>
            <div className='py-6 px-4 shadow relative'>
                <p className='font-semibold'>Loyalty Programme</p>
                <p className='mt-2 '>you can collect and redeem regularly, get gifts, rewards.</p>
                <img src="/images/icon6.png" alt=""  className='h-14 w-14 object-cover absolute top-6 -right-8'/>
            </div> 
        </div>
      </div>
    </div>
